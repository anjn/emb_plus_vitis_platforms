...
proc init_gui { IPINST } {
  ...
  set General_Config [ipgui::add_page $IPINST -name "General Config"]
    ...
    set_property tooltip  "Manually configure all bar layout parameters (disables automatic propagation of endpoint metadata)"  $C_MANUAL
    ...
    set_property tooltip  "Set the Next Capability Pointer. Leave at 0x000 if this is the last capability. Valid range is from (C_CAP_BASE_ADDR + 0x010) - 0xFFF"  $C_NEXT_CAP_ADDR
		...
		set_property tooltip  "Dictionary of endpoint names for PF0" $C_PF0_ENDPOINT_NAMES
		set C_PF1_ENDPOINT_NAMES [ipgui::add_param $IPINST -name C_PF1_ENDPOINT_NAMES -parent $General_Config]
		set_property tooltip  "Dictionary of endpoint names for PF1" $C_PF1_ENDPOINT_NAMES
		set C_PF2_ENDPOINT_NAMES [ipgui::add_param $IPINST -name C_PF2_ENDPOINT_NAMES -parent $General_Config]
		set_property tooltip  "Dictionary of endpoint names for PF2" $C_PF2_ENDPOINT_NAMES
		set C_PF3_ENDPOINT_NAMES [ipgui::add_param $IPINST -name C_PF3_ENDPOINT_NAMES -parent $General_Config]
		set_property tooltip  "Dictionary of endpoint names for PF3" $C_PF3_ENDPOINT_NAMES
    set C_INJECT_ENDPOINTS [ipgui::add_param $IPINST -name C_INJECT_ENDPOINTS -parent $General_Config]
    set_property tooltip  "Endpoint properties dictionary to inject in place of vitis metadata for test (used only if vitis call returns empty string)"  $C_INJECT_ENDPOINTS
